...
const repeatMyParam = () => {
    ...
    axios.get('http://localhost:3000/repeat/coding-is-cool')
    .then((res) => {
...
// CODE HERE
const newQuery = () => {
    axios.get('http://localhost:3000/query-test?phrase=Coding-is-fun')
    .then((res) => {
        console.log(res.data)
    })
}
...
error occurs
    ...
    adds second query onto your original query
*/
...
const createFood = () => {
    document.getElementById('food-list-form') = foodInput;
    let bodyObj = {
